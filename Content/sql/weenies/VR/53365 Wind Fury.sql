...
VALUES (53365, 'ace53365-windfury', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (53365,   1,       5) /* HeartbeatInterval */
     ...
     , (53365,  17,       2) /* ArmorModVsFire */
     , (53365,  18,     1.7) /* ArmorModVsAcid */
     , (53365,  19,       2) /* ArmorModVsElectric */
...
VALUES (53365,   1, 0x02001C19) /* Setup */
     ...
     , (53365,   4, 0x30000000) /* CombatTable */
     , (53365,   6, 0x0400007E) /* PaletteBase */
     , (53365,   7, 0x1000086B) /* ClothingBase */
...
VALUES (53365,  0,  4,  0,    0,  400,  760,  760,  720,  680,  800,  680,  800,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (53365,  1,  4,  0,    0,  400,  760,  760,  720,  680,  800,  680,  800,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (53365,  2,  4,  0,    0,  400,  760,  760,  720,  680,  800,  680,  800,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (53365,  3,  4,  0,    0,  400,  760,  760,  720,  680,  800,  680,  800,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (53365,  4,  4,  0,    0,  400,  760,  760,  720,  680,  800,  680,  800,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (53365,  5,  4, 600, 0.75,  400,  760,  760,  720,  680,  800,  680,  800,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (53365,  6,  4,  0,    0,  400,  760,  760,  720,  680,  800,  680,  800,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (53365,  7,  4,  0,    0,  400,  760,  760,  720,  680,  800,  680,  800,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (53365,  8,  4, 600, 0.75,  400,  760,  760,  720,  680,  800,  680,  800,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (53365, 14 /* Taunt */,    0.1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
VALUES (53365, 2, 52633,  1, 0, 0, False) /* Create A'nekshen Stormwood Spear (52633) for Wield */
     , (53365, 9, 53366,  0, 0, 1, False) /* Create Essence of Wind Fury (53366) for ContainTreasure */
     , (53365, 9, 53366,  0, 0, 1, False) /* Create Essence of Wind Fury (53366) for ContainTreasure */
     , (53365, 9, 53366,  0, 0, 1, False) /* Create Essence of Wind Fury (53366) for ContainTreasure */
     , (53365, 9, 53366,  0, 0, 1, False) /* Create Essence of Wind Fury (53366) for ContainTreasure */
     , (53365, 9, 53366,  0, 0, 1, False) /* Create Essence of Wind Fury (53366) for ContainTreasure */
