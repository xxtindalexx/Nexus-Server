...
VALUES (72001, 'ace72001-norshuntyr', 10, '2022-12-04 19:04:52') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (72001,   1,         16) /* ItemType - Creature */
     , (72001,   2,         62) /* CreatureType - Elemental */
     , (72001,   6,         -1) /* ItemsCapacity */
     , (72001,   7,         -1) /* ContainersCapacity */
...
VALUES (72001,   1, 0x02001C27) /* Setup */
     , (72001,   2, 0x09000081) /* MotionTable */
     , (72001,   3, 0x20000015) /* SoundTable */
     , (72001,   4, 0x30000000) /* CombatTable */
     , (72001,   8, 0x06001224) /* Icon */
     , (72001,  22, 0x3400005E) /* PhysicsEffectTable */
...
VALUES (72001,  6, 0, 2, 0, 530, 0, 0) /* MeleeDefense        Trained */
     , (72001,  7, 0, 2, 0, 550, 0, 0) /* MissileDefense      Trained */
     , (72001, 15, 0, 2, 0, 360, 0, 0) /* MagicDefense        Trained */
...
VALUES (72001,  0,  4,  0,    0,  430,  344,  344,  344,  430,  258,  430,  344,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (72001,  1,  4,  0,    0,  430,  344,  344,  344,  430,  258,  430,  344,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (72001,  2,  4,  0,    0,  430,  344,  344,  344,  430,  258,  430,  344,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (72001,  3,  4,  0,    0,  430,  344,  344,  344,  430,  258,  430,  344,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (72001,  4,  4,  0,    0,  430,  344,  344,  344,  430,  258,  430,  344,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (72001,  5,  4, 700, 0.75,  430,  344,  344,  344,  430,  258,  430,  344,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (72001,  6,  4,  0,    0,  430,  344,  344,  344,  430,  258,  430,  344,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (72001,  7,  4,  0,    0,  430,  344,  344,  344,  430,  258,  430,  344,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (72001,  8,  4, 700, 0.75,  430,  344,  344,  344,  430,  258,  430,  344,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (72001, 14 /* Taunt */,    0.1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
VALUES (72001, 9, 53362,  0, 0, 1, False) /* Create Essence of Norshuntyr (53362) for ContainTreasure */
     , (72001, 9, 53362,  0, 0, 1, False) /* Create Essence of Norshuntyr (53362) for ContainTreasure */
     , (72001, 9, 53362,  0, 0, 1, False) /* Create Essence of Norshuntyr (53362) for ContainTreasure */
     , (72001, 9, 53362,  0, 0, 1, False) /* Create Essence of Norshuntyr (53362) for ContainTreasure */
     , (72001, 9, 53362,  0, 0, 1, False) /* Create Essence of Norshuntyr (53362) for ContainTreasure */
     , (72001, 9, 53362,  0, 0, 1, False) /* Create Essence of Norshuntyr (53362) for ContainTreasure */
