        ...
        public static List<PKQuest> PkQuestList
        {
            get
            {
                if (_pkQuestList == null)
                {
                    ...
                    arena_any_5.RewardDescription = "20k luminance, 25% XP to next level, 1 Rookie Key, 1 Arena Token, 5 Nexus Tokens";
                    arena_any_5.Rewards = new List<string>() { "LUM,14000", "XP%,17", "DBKEY,0", "nexustoken,5", "PHIAL,1" };
                    ...
                    arena_any_15.RewardDescription = "50k luminance, 50% XP to next level, 3 Rookie Keys, 2 Arena Tokens, 25 Nexus Tokens, 1 Box";
                    arena_any_15.Rewards = new List<string>() { "LUM,35000", "XP%,35", "DBKEY,2", "nexustoken,25", "PHIAL,2", "BOX,0" };
                    ...
                    arena_any_30.RewardDescription = "150k luminance, 100% XP to next level, 3 Rookie Keys, 3 Arena Tokens, 100 Nexus Tokens, 2 Boxes, 1 Hera Key.";
                    arena_any_30.Rewards = new List<string>() { "LUM,105000", "XP%,70", "DBKEY,2", "nexustoken,100", "PHIAL,3", "BOX,1", "HERA,1" };
                    ...
                    arena_any_win_10.RewardDescription = "30k luminance, 100% XP to next level, 3 Rookie Keys, 2 Arena Tokens, 40 Nexus Tokens, 1 Box";
                    arena_any_win_10.Rewards = new List<string>() { "LUM,21000", "XP%,70", "DBKEY,2", "nexustoken,40", "PHIAL,2", "BOX,0" };
                    ...
                    arena_any_win_20.RewardDescription = "100k luminance, 100% XP to next level, 3 Rookie Keys, 3 Arena Tokens, 100 Nexus Tokens, 3 Boxes, 1 Hera Key";
                    arena_any_win_20.Rewards = new List<string>() { "LUM,70000", "XP%,70", "DBKEY,2", "nexustoken,100", "PHIAL,3", "BOX,2", "HERA,1" };
                    ...
                    arena_any_win_30.RewardDescription = "200k luminance, 100% XP to next level, 5 Rookie Keys, 5 Arena Tokens, 200 Nexus Tokens, 5 Boxes, 3 Hera Key";
                    arena_any_win_30.Rewards = new List<string>() { "LUM,140000", "XP%,70", "DBKEY,3", "nexustoken,200", "PHIAL,5", "BOX,3", "HERA,3" };
                    ...
                    arena_1v1_10.RewardDescription = "20k luminance, 25% XP to next level, 1 Rookie Key, 1 Arena Token, 5 Nexus Tokens";
                    arena_1v1_10.Rewards = new List<string>() { "LUM,14000", "XP%,17", "DBKEY,0", "nexustoken,5", "PHIAL,1" };
                    ...
                    arena_1v1_20.RewardDescription = "50k luminance, 50% XP to next level, 3 Rookie Keys, 3 Arena Tokens, 25 Nexus Tokens";
                    arena_1v1_20.Rewards = new List<string>() { "LUM,35000", "XP%,35", "DBKEY,2", "nexustoken,25", "PHIAL,3" };
